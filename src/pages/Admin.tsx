...
const Admin = () => {
  ...
  const { uploadProductImages, isUploading: isUploadingImages } =
    useImageUpload();
  ...
  const [orderCommentStatus, setOrderCommentStatus] = useState<
  ...
  const handleEditProduct = async (e: React.FormEvent) => {
    ...
    const productData = {
      ...
      discounted_price: editProduct.discounted_price
        ? parseFloat(editProduct.discounted_price)
        : null,
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="orders">
          <TabsList className="mb-6 grid w-full grid-cols-2 lg:grid-cols-2">
            <TabsTrigger value="orders">
              <ShoppingBag className="w-4 h-4 mr-2" /> Orders ({orders.length})
            </TabsTrigger>
                          ...
                          <TableCell>
                            {order.payment_proof_url ? (
                              <ViewPaymentProofButton
                                filePath={order.payment_proof_url}
                              />
                            ) : (
                  ...
                  <form onSubmit={handleAddProduct} className="space-y-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setNewProduct({
                              ...newProduct,
                              discount_expiry: e.target.value,
                            })
                          }
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {selectedImageFiles.length} image(s) selected • Max 5MB
                        per image
                      </p>
                    </div>
                ...
                >
                  ...
                  <form onSubmit={handleEditProduct} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        <Label htmlFor="edit-discounted_price">
                          Discounted Price (RWF)
                        </Label>
                        <Input
                      ...
                      <div>
                        <Label htmlFor="edit-discount_expiry">
                          Discount Expiry
                        </Label>
                        <Input
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="text-right">
                              ...
                              <p
                                className={`text-lg font-bold ${product.stock_quantity > 0 ? "text-green-600" : "text-red-600"}`}
                              >
        ...
        <Dialog
          open={showOrderCommentDialog}
          onOpenChange={setShowOrderCommentDialog}
        >
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              <DialogTitle>Update Order Status</DialogTitle>
              <DialogDescription>
                Set the order status and optionally add a comment for the
                customer
              </DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter>
              <Button
                variant="outline"
                onClick={() => setShowOrderCommentDialog(false)}
              >
                Cancel
              </Button>
              <Button
            ...
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                <div className="space-y-2">
                  ...
                  <p>Deleting this order will permanently remove:</p>
                  ...
                  <p className="font-semibold mt-3">
                    Are you absolutely sure you want to delete this order? This
                    will cause loss of client's data.
                  </p>
                </div>
              </AlertDialogDescription>
            </AlertDialogHeader>
